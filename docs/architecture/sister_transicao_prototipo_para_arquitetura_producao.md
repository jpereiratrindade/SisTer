...
| SEC-01C — robustez HTTP e dos workers | implementado e validado; publicação planejada em `v0.2.6` |
| SEC-01D — contenção de abuso | implementado e validado; publicação planejada em `v0.2.6` |
| SEC-02 — identidade interna assinada | implementado; validação formal e implantação pendentes |
