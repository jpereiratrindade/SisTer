...
def main():
    ...
    unsafe_mutations = (
        ...
        ("network.upstream_transport", "tcp"),
        ("network.upstream_socket", "/tmp/sisterd.sock"),
        ("network.sisterd_inbound_tcp", True),
        ("network.socket_activation_required", False),
        ...
        ("realizability.iso_01_resolution.merge_authorized", True),
